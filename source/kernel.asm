...
[SEGMENT .data]
    strWelcomeMsg   db  "Hello Welcome to Udesh_OS Version 1.0.1 - Enter help to display commands", 0x00
	strPrompt		db	"Udesh_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Udesh", 0x00	;OS details
	...
	strHelpMsg1		db  "Type version to input new version",0x00
	strHelpMsg2		db  "Type info for displaying Hardware informations of the machine",0x00
	strHelpMsg3		db  "Enter exit rebooting the system",0x00
